...
const MonitorIotHome = () => {
  ...
  const handleChange = (event) => {
    ...
    if(event.target.value == 2){
      navigate('/client/monitor/iot/lights');
    } 
     if (event.target.value == 1) {
      navigate('/client/monitor/iot/fans');
